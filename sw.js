...
const CACHE = 'qk-v0.10';
const SOUBORY = ['./', 'index.html', 'css/app.css', 'js/app.js', 'js/ui.js', 'js/projekt.js', 'js/uloziste.js', 'js/body.js', 'js/zapisnik.js', 'js/vypocty.js', 'js/mapa.js', 'js/protokol.js', 'js/stred.js', 'js/soubory.js', 'js/import-totalka.js', 'js/import-ui.js', 'js/export.js', 'js/vypocty2.js', 'js/vypocty3.js', 'geo/vyrovnani.js', 'js/ucet.js', 'js/seznam-nastroje.js', 'js/zapisnik-nastroje.js', 'js/format-uziv.js', 'js/formaty.js', 'js/tisk.js', 'js/nastaveni.js', 'geo/krovak.js', 'geo/osa.js',

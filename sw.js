...
const CACHE = 'qk-v0.3';
const SOUBORY = ['./', 'index.html', 'css/app.css', 'js/app.js', 'js/ui.js', 'js/projekt.js', 'js/uloziste.js', 'js/body.js', 'js/zapisnik.js', 'js/vypocty.js', 'js/mapa.js', 'js/protokol.js', 'js/stred.js', 'js/soubory.js', 'js/import-totalka.js', 'js/import-ui.js', 'js/export.js', 'geo/krovak.js',

...
import { el, $, fmt, fmtG, cislo, toast, potvrd, zeptej } from './ui.js';
...
export const Zapisnik = {
    init(root) {
        kore = root;
        root.append(el('div', { class: 'nastroje' }, el('button', { class: 'btn maly hlavni', onclick: nove }, '+ Stanovisko'), el('button', { class: 'btn maly', id: 'zap-import', onclick: () => document.dispatchEvent(new CustomEvent('import-zapisnik')) }, 'Import z totálky')), el('div', { id: 'zap-seznam' }));
...
function editor(sek, s) {
    ...
    const tab = el('table', { class: 'tab bez-nastroju' }, el('thead', {}, el('tr', {}, el('th', {}, 'Typ'), el('th', {}, 'Cíl'), el('th', { class: 'num' }, 'Hz [g]'), el('th', { class: 'num' }, 'Zenit [g]'), el('th', { class: 'num' }, s.delky === 'vodorovne' ? 'Vodor. délka' : 'Šikmá délka'), el('th', { class: 'num' }, 'V. cíle'), el('th', {}, 'Kód'), el('th', {}, ''))));
    ...
    const radek = (r, i) => {
        ...
        tr.append(
            ...
            el('td', { class: 'cislo' }, inp('cislo', false)), el('td', { class: 'num' }, inp('hz', true, 4)), el('td', { class: 'num' }, inp('z', true, 4)), el('td', { class: 'num' }, inp('ds', true, 3)), el('td', { class: 'num' }, inp('vc', true, 3)), el('td', {}, inp('kod', false)),
